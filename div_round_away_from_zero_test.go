...
func TestDivRoundAwayFromZero_Small(t *testing.T) {
	testCases := []testcaseDiv{
		{
...
func TestDivRoundAwayFromZero_Half(t *testing.T) {
	testCases := []testcaseDiv{
		{
...
func TestDivRoundAwayFromZero_Close(t *testing.T) {
	testCases := []testcaseDiv{
		{
...
func TestDivRoundAwayFromZero_Error(t *testing.T) {
