...
func TestDivRoundHalfAwayFromZero_Simple(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(fmt.Sprintf(`(%3d/%3d)`, tc.a, tc.b), func(t *testing.T) {
			doTestDiv(t, div.DivRound, tc)
		})
	}
}

func TestDivRoundHalfAwayFromZero_Small(t *testing.T) {
	testCases := []testcaseDiv{
		{
...
func TestDivRoundHalfAwayFromZero_Half(t *testing.T) {
	testCases := []testcaseDiv{
		{
...
func TestDivRoundHalfAwayFromZero_Close(t *testing.T) {
	testCases := []testcaseDiv{
		{
...
func TestDivRound_Error(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(fmt.Sprintf(`(%20d/%20d)`, tc.a, tc.b), func(t *testing.T) {
			doTestDivErr(t, div.DivRound, tc)
		})
	}
}
