...
func TestDivTrunc_Simple(t *testing.T) {
...
func TestDivTrunc_Half(t *testing.T) {
	testCases := []testcaseDiv{
		{
...
func TestDivTrunc_Close(t *testing.T) {
	testCases := []testcaseDiv{
		{
...
func TestDivTrunc_Error(t *testing.T) {
